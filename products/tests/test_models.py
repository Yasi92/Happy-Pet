...
class TestModels(TestCase):
    ...
    def setUp(self):
        ...
        self.category= Category.objects.create(category_id=6, name='test_category', friendlyname='test_friendlyname')
        self.subcategory = Subcategories.objects.create(subcategory_id=67, name="test_subcategory")
    ...
    def test_str_method_of_category_model(self):
        self.assertEquals(self.category.__str__(), 'test_category')  


    def test_category_get_friendly_name_method(self):
        self.assertEquals(self.category.get_friendly_name(), 'test_friendlyname')     
    ...
    def test_product_model(self):     
        ...
        self.assertEquals(self.product.subcategory.name, 'test_subcategory')    
    ...
    def test_ProductReview_model(self):
        ...
        self.assertEquals(self.product_review.content, 'test review product content')
