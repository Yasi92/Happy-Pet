    ...
    def setUp(self):
        ...
        self.product = Product.objects.create(
            ...
            category=Category.objects.create(
                category_id=6, name='test'),

            subcategory=Subcategories.objects.create(
                subcategory_id=67, name="sub_test"),

            price=11.2, sku=46576)
        self.product_detail_url = reverse(
            'product_detail', args=[self.product.product_id])
...
class TestLogInRequiredViews(TestCase):
    ...
    def test_edit_product_GET_request(self):
        product_init = Product.objects.create(
            name='test_product3',
            category=Category.objects.create(
                category_id=6, name='test_category'),
        ...
        self.edit_product_url = reverse(
            'edit_product', args=[product_init.product_id])
    ...
    def test_delete_product_GET_request(self):
        self.product_init = Product.objects.create(
            name='test_product5',
            category=Category.objects.create(
                category_id=6, name='test_category'),
            subcategory=Subcategories.objects.create(
        ...
        self.delete_product_url = reverse(
            'delete_product',
            args=[self.product_init.product_id])
