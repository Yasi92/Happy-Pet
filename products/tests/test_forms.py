...
class TestForms(SimpleTestCase):
    ...
    def test_product_review_form_with_no_data(self):
        ...
        # 1 is set as form error length since there is only 1 required field
    ...
    def test_product_review_form_with_invalid_data(self):
        ...
        self.assertFalse(form.is_valid())
        self.assertEqual(form.errors['stars'][0], 'Enter a whole number.')


    def test_product_form_with_valid_data(self):
        ''' Tests product form with valid data '''

        category = Category.objects.create(name='test_category1', category_id=5)
        subcategory = Subcategories.objects.create(name='test_subcategory1', subcategory_id=5)
    ...
    def test_product_form_with_invalid_data(self):
        ...
        category = Category.objects.create(name='test_category1', category_id=8)
        subcategory = Subcategories.objects.create(name='test_subcategory1', subcategory_id=98)
