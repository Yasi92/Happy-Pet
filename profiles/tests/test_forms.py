...
class TestForms(SimpleTestCase):
    ...
    def test_product_review_form_with_invalid_data(self):
        ...
        # The default_country is a select field of countries and the value should be a valid choice
        self.assertEqual(form.errors['default_country'][0], 
                        'Select a valid choice. non-existent country is not one of the available choices.')
